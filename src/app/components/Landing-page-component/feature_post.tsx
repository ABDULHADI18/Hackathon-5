  ...
  return (
    <div className="mt-32">
      ...
      <div className="flex flex-wrap justify-center items-center gap-5">
        ...
        {["feature-post-1.png", "feature-post-2.png", "feature-post-3.png"].map((feature_post, index) => (
          <div
            key={index}
            className="max-w-xs sm:max-w-sm bg-white shadow-lg rounded-lg overflow-hidden transform transition-transform duration-300 flex flex-col items-center"
          >
            {/* Image Section */}
            ...
            <div className="p-4 text-center">
              ...
              <div className="flex justify-between items-center mt-4 text-[12px] text-[#737373]">
                ...
                <div className="flex items-center space-x-2">
                  {/* Comment Icon */}
                  <BsGraphUp className="w-4 h-4 text-[#23856D]" />
              ...
              <div className="mt-4 flex items-center justify-start">
                <button className="text-[#737373] text-sm font-bold py-2 px-4 rounded-md bg-transparent hover:bg-[#23A6F0] hover:text-white transition-all duration-300 flex items-center space-x-2">
