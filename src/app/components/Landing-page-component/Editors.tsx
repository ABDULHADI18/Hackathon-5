...
const Editors = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center mt-16 mb-7 bg-[#FAFAFA] pt-3">
      ...
      {/* Desktop Layout */}
      <div className="hidden sm:flex justify-center items-start gap-5 mt-6">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="relative">
            <Image src={"/accessories.png"} alt="accessories" width={237} height={220} />
            <div className="absolute bottom-4 left-4 w-[170px] h-[48px] bg-white flex items-center justify-center">
          ...
          <div className="relative">
            <Image src={"/kids.png"} alt="kids" width={237} height={220} />
            <div className="absolute bottom-4 left-4 w-[170px] h-[48px] bg-white flex items-center justify-center">
